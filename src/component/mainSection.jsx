export default function mainSection(props) {
  return (
    ...
    <div id="hero-section" className="flex flex-col items-center gap-8">
        <div id="version-box" className="flex items-center gap-2 border border-amber-500 rounded-lg bg-orange-50 font-medium shadow-md 
    ...
    <div id="hero-section-mobile" className="hidden md: flex flex-col items-center gap-8">
        ...
        <h1 className="text-start text-5xl font-bold text-zinc-800 w-[360px] text-center">Web app to Desktop app in minutes</h1>
        
        <p className="text-xl text-start w-[360px]">Take your web app codebase and transform it into a cross platform desktop app with native functionality.</p>

        {/* <div id="hero-sect-mobile-btn" className="flex flex-col gap-5">
            <button className="rounded-lg w-[360px] font-medium">Download now</button>
            <button className="border border-gray-500 rounded-lg w-[360px] font-medium">Read more</button>
        </div> */}
